...
VALUES
    (1, 1, '조회 테스트 그룹 1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 1, '조회 테스트 그룹 2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
    (100, 1, NULL, '조회테스트_루트1', 'http://root1.com', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (101, 1, 100, '조회테스트_자식1-1', 'http://child1-1.com', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (102, 1, 100, '조회테스트_자식1-2', 'http://child1-2.com', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (103, 1, 102, '조회테스트_손자1-1', 'http://gc1-1.com', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (104, 1, NULL, '조회테스트_루트2', 'http://root2.com', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- 테스트용 트리 구조 (그룹 2)
INSERT INTO tabs (id, group_id, parent_id, title, url, position, created_at, updated_at)
VALUES
    (200, 2, NULL, '조회테스트_그룹2_루트', 'http://g2root.com', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
